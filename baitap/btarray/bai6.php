...
if (isset($_POST['submit'])){
    ...
    $giam = implode(",",Giam($original));
    $tang = implode(",",Tang($original));
}
?>
...
<table align="center" bgcolor="#a9a9a9">
    ...
    <tr>
        <td>Tang Dan</td>
        <td>
            <input type="text" value="<?php if (isset($tang)) echo  $tang;?>" size="35">
        </td>
        <td></td>
    </tr>
    <tr>
        <td>Giam Dan</td>
        <td>
            <input type="text" value="<?php if (isset($giam)) echo  $giam;?>" size="35">
        </td>
        <td></td>
    </tr>
    <tr>
